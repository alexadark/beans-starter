...
echo beans_open_markup( 'lightbox-gallery-figure' . $filter . '', 'figure', array(
	'class' => 'uk-overlay 
	uk-overlay-hover'
) );
...
echo beans_open_markup( 'lightbox_gallery_overlay_content' . $filter . '', 'div', array( 'class' => 'tm-lightbox-content uk-overlay-panel uk-overlay-slide-top uk-flex uk-flex-center uk-flex-middle uk-text-center' ) );
echo '<div>';
echo $content;
echo '</div>';
